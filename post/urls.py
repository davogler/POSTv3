...
urlpatterns = patterns('',
    ...
    url(r'^issue-four/$', RedirectView.as_view(url='/issues/4/', permanent=True)),
    url(r'^issue-five/$', RedirectView.as_view(url='/issues/5/', permanent=True)),
    url(r'^issue-6/$', RedirectView.as_view(url='/issues/6/', permanent=True)),
    url(r'^issue-7/$', RedirectView.as_view(url='/issues/7/', permanent=True)),
