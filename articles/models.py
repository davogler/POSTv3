...
class Article(models.Model):
    ...
    intro = models.TextField(
        blank=True, help_text='For article list view teaser- can be identical to standfirst if desired.')
    standfirst = models.TextField(blank=True, help_text='First paragraph in article body.')
    body = models.TextField()
    slug = models.SlugField(unique_for_date='pub_date')
    hero = FileBrowseField("Hero Image", max_length=200, extensions=[
                           ".jpg", ".png", ".gif"], blank=True, null=True, help_text='Choose an huge image for this article. Minimum 1280 x 900')
    hero_alt = FileBrowseField("Hero Alternate Image", max_length=200, extensions=[
                               ".jpg", ".png", ".gif"], blank=True, null=True, help_text='For displaying in SM metadata. (FB:1280x670) Optional.')
    ...
    logo_outline = models.CharField(
        max_length=250, default='#ffffff', help_text='Hex color for Post logo outline #ffffff')
    nav_color = models.CharField(max_length=250, default='#0073b6', help_text='Hex color for Nav links #0073b6')
    nav_hover = models.CharField(
        max_length=250, default='#a7a7a7', help_text='Hex color for Nav link hover state #a7a7a7')
    template_name = models.CharField(
        max_length=250, blank=True, help_text='enter optional template to override default')
...
class Image(models.Model):
    ...
    image = FileBrowseField("Inline IMage", max_length=200, extensions=[
                            ".jpg", ".png", ".gif", ".svg"], blank=True, null=True, help_text='Inline image, yo. 960 640 or 525')
...
class Issue(models.Model):
    ...
    title = models.CharField(
        max_length=250, default='A Magazine About Rochester', help_text='A Magazine About Rochester')
    tagline = models.TextField(
        blank=True, default='Stories From the City We Love', help_text='Stories From the City We Love')
    inside = models.TextField(blank=True, null=True, help_text='Brief listing of what is inside this issue.')
    hero = FileBrowseField("Hero Image", max_length=200, extensions=[
                           ".jpg", ".png", ".gif"], blank=True, null=True, help_text='Choose a huge image for this article. Minimum 1280 x 900')
    hero_alt = FileBrowseField("Hero Alternate Image", max_length=200, extensions=[
                               ".jpg", ".png", ".gif"], blank=True, null=True, help_text='For displaying in SM metadata. (FB:1280 x 670) Optional.')
    pub_date = models.DateTimeField(
        default=datetime.datetime.now, help_text='Pick first of first month, for ordering', blank=True)
    ...
    cover_img = FileBrowseField("Cover Image", max_length=200, extensions=[
                                ".jpg", ".png", ".gif"], blank=True, null=True, help_text='Upload a cover image; pick any version')
    special_js = models.TextField(blank=True)
    special_css = models.TextField(blank=True, null=True, help_text='Mainly h2.unique and p.tagline')
    logo_fill = models.CharField(max_length=250, default='#333333', help_text='Hex color for Post logo #333333')
    logo_outline = models.CharField(
...
class Sponsor(models.Model):
    ...
    adimg = FileBrowseField("Ad Image", max_length=200, extensions=[
