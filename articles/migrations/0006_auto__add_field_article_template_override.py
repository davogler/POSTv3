...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.template_override'
        db.add_column(u'articles_article', 'template_override',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.template_override'
        db.delete_column(u'articles_article', 'template_override')
    ...
    models = {
        u'articles.article': {
            ...
            'template_override': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
