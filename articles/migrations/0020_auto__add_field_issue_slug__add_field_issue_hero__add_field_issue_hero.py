...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'articles_issue', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default=datetime.datetime(2014, 10, 11, 0, 0), max_length=50),
                      keep_default=False)

        # Adding field 'Issue.hero'
        db.add_column(u'articles_issue', 'hero',
                      self.gf('filebrowser.fields.FileBrowseField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Issue.hero_alt'
        db.add_column(u'articles_issue', 'hero_alt',
                      self.gf('filebrowser.fields.FileBrowseField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Issue.screen'
        db.add_column(u'articles_issue', 'screen',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Issue.special_js'
        db.add_column(u'articles_issue', 'special_js',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Issue.special_css'
        db.add_column(u'articles_issue', 'special_css',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Issue.template_name'
        db.add_column(u'articles_issue', 'template_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'Issue.status'
        db.add_column(u'articles_issue', 'status',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'articles_issue', 'slug')

        # Deleting field 'Issue.hero'
        db.delete_column(u'articles_issue', 'hero')

        # Deleting field 'Issue.hero_alt'
        db.delete_column(u'articles_issue', 'hero_alt')

        # Deleting field 'Issue.screen'
        db.delete_column(u'articles_issue', 'screen')

        # Deleting field 'Issue.special_js'
        db.delete_column(u'articles_issue', 'special_js')

        # Deleting field 'Issue.special_css'
        db.delete_column(u'articles_issue', 'special_css')

        # Deleting field 'Issue.template_name'
        db.delete_column(u'articles_issue', 'template_name')

        # Deleting field 'Issue.status'
        db.delete_column(u'articles_issue', 'status')
    ...
    models = {
        ...
        u'articles.sponsor': {
            ...
            'add_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 11, 0, 0)'}),
