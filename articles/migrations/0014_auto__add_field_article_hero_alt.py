...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.hero_alt'
        db.add_column(u'articles_article', 'hero_alt',
                      self.gf('filebrowser.fields.FileBrowseField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.hero_alt'
        db.delete_column(u'articles_article', 'hero_alt')
    ...
    models = {
        ...
        u'articles.sponsor': {
            ...
            'add_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 17, 0, 0)'}),
