...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Article.hero_credit'
        db.alter_column(u'articles_article', 'hero_credit', self.gf('django.db.models.fields.CharField')(max_length=250))

    def backwards(self, orm):

        # Changing field 'Article.hero_credit'
        db.alter_column(u'articles_article', 'hero_credit', self.gf('django.db.models.fields.TextField')())
