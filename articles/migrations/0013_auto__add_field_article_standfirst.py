...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.standfirst'
        db.add_column(u'articles_article', 'standfirst',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.standfirst'
        db.delete_column(u'articles_article', 'standfirst')
