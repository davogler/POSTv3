...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Article.template_override'
        db.alter_column(u'articles_article', 'template_override', self.gf('django.db.models.fields.CharField')(max_length=250))

    def backwards(self, orm):

        # Changing field 'Article.template_override'
        db.alter_column(u'articles_article', 'template_override', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        u'articles.article': {
            ...
            'template_override': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'}),
        ...
        u'articles.sponsor': {
            ...
            'add_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 18, 0, 0)'}),
