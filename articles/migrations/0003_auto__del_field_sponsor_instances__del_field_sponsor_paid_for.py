...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Sponsor.instances'
        db.delete_column(u'articles_sponsor', 'instances')

        # Deleting field 'Sponsor.paid_for'
        db.delete_column(u'articles_sponsor', 'paid_for')


    def backwards(self, orm):
        # Adding field 'Sponsor.instances'
        db.add_column(u'articles_sponsor', 'instances',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Sponsor.paid_for'
        db.add_column(u'articles_sponsor', 'paid_for',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'articles.sponsor': {
            ...
            'add_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 15, 0, 0)'}),
