...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'articles_issue', 'title',
                      self.gf('django.db.models.fields.CharField')(default='A Magazine About Rochester', max_length=250),
                      keep_default=False)

        # Adding field 'Issue.tagline'
        db.add_column(u'articles_issue', 'tagline',
                      self.gf('django.db.models.fields.TextField')(default='Because Rochester is Awesome', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Issue.title'
        db.delete_column(u'articles_issue', 'title')

        # Deleting field 'Issue.tagline'
        db.delete_column(u'articles_issue', 'tagline')
