...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field illus on 'Article'
        m2m_table_name = db.shorten_name(u'articles_article_illus')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('article', models.ForeignKey(orm[u'articles.article'], null=False)),
            ('illus', models.ForeignKey(orm[u'articles.illus'], null=False))
        ))
        db.create_unique(m2m_table_name, ['article_id', 'illus_id'])


    def backwards(self, orm):
        # Removing M2M table for field illus on 'Article'
        db.delete_table(db.shorten_name(u'articles_article_illus'))
    ...
    models = {
        ...
        u'articles.sponsor': {
            ...
            'add_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 23, 0, 0)'}),
