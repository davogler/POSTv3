...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.logo_fill'
        db.add_column(u'articles_article', 'logo_fill',
                      self.gf('django.db.models.fields.CharField')(default='#333333', max_length=250),
                      keep_default=False)

        # Adding field 'Article.logo_outline'
        db.add_column(u'articles_article', 'logo_outline',
                      self.gf('django.db.models.fields.CharField')(default='#ffffff', max_length=250),
                      keep_default=False)

        # Adding field 'Article.nav_color'
        db.add_column(u'articles_article', 'nav_color',
                      self.gf('django.db.models.fields.CharField')(default='#0073b6', max_length=250),
                      keep_default=False)

        # Adding field 'Article.nav_hover'
        db.add_column(u'articles_article', 'nav_hover',
                      self.gf('django.db.models.fields.CharField')(default='#a7a7a7', max_length=250),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.logo_fill'
        db.delete_column(u'articles_article', 'logo_fill')

        # Deleting field 'Article.logo_outline'
        db.delete_column(u'articles_article', 'logo_outline')

        # Deleting field 'Article.nav_color'
        db.delete_column(u'articles_article', 'nav_color')

        # Deleting field 'Article.nav_hover'
        db.delete_column(u'articles_article', 'nav_hover')
    ...
    models = {
        ...
        u'articles.sponsor': {
            ...
            'add_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 26, 0, 0)'}),
