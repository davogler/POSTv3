...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Issue.logo_fill'
        db.add_column(u'articles_issue', 'logo_fill',
                      self.gf('django.db.models.fields.CharField')(default='#333333', max_length=250),
                      keep_default=False)

        # Adding field 'Issue.logo_outline'
        db.add_column(u'articles_issue', 'logo_outline',
                      self.gf('django.db.models.fields.CharField')(default='#ffffff', max_length=250),
                      keep_default=False)

        # Adding field 'Issue.nav_color'
        db.add_column(u'articles_issue', 'nav_color',
                      self.gf('django.db.models.fields.CharField')(default='#0073b6', max_length=250),
                      keep_default=False)

        # Adding field 'Issue.nav_hover'
        db.add_column(u'articles_issue', 'nav_hover',
                      self.gf('django.db.models.fields.CharField')(default='#a7a7a7', max_length=250),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Issue.logo_fill'
        db.delete_column(u'articles_issue', 'logo_fill')

        # Deleting field 'Issue.logo_outline'
        db.delete_column(u'articles_issue', 'logo_outline')

        # Deleting field 'Issue.nav_color'
        db.delete_column(u'articles_issue', 'nav_color')

        # Deleting field 'Issue.nav_hover'
        db.delete_column(u'articles_issue', 'nav_hover')
    ...
    models = {
        ...
        u'articles.sponsor': {
            ...
            'add_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 24, 0, 0)'}),
