...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Issue.he_link'
        db.add_column(u'articles_issue', 'he_link',
                      self.gf('django.db.models.fields.URLField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Issue.sku'
        db.add_column(u'articles_issue', 'sku',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Issue.he_link'
        db.delete_column(u'articles_issue', 'he_link')

        # Deleting field 'Issue.sku'
        db.delete_column(u'articles_issue', 'sku')
