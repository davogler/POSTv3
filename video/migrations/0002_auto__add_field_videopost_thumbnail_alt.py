...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoPost.thumbnail_alt'
        db.add_column(u'video_videopost', 'thumbnail_alt',
                      self.gf('filebrowser.fields.FileBrowseField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VideoPost.thumbnail_alt'
        db.delete_column(u'video_videopost', 'thumbnail_alt')
    ...
    models = {
        ...
        u'articles.sponsor': {
            ...
            'add_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 6, 0, 0)'}),
        ...
        u'video.videopost': {
            ...
            'thumbnail_alt': ('filebrowser.fields.FileBrowseField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
